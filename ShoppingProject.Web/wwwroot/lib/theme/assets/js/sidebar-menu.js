...
if ($('#pageWrapper').hasClass('compact-wrapper')) {
    jQuery('.sidebar-title').append('<div class="according-menu"><i class="icofont-rounded-right"></i></div>');
    jQuery('.sidebar-title').click(function () {
        jQuery('.sidebar-title').removeClass('active').find('div').replaceWith('<div class="according-menu"><i class="icofont-rounded-right"></i></div>');
        jQuery('.sidebar-submenu, .menu-content').slideUp('normal');
        jQuery('.menu-content').slideUp('normal');
        if (jQuery(this).next().is(':hidden') == true) {
            jQuery(this).addClass('active');
            jQuery(this).find('div').replaceWith('<div class="according-menu"><i class="icofont-rounded-down"></i></div>');
            jQuery(this).next().slideDown('normal');
        } else {
            jQuery(this).find('div').replaceWith('<div class="according-menu"><i class="icofont-rounded-right"></i></div>');
        }
    });
    jQuery('.sidebar-submenu, .menu-content').hide();
    jQuery('.submenu-title').append('<div class="according-menu"><i class="icofont-rounded-right"></i></div>');
    jQuery('.submenu-title').click(function () {
        jQuery('.submenu-title').removeClass('active').find('div').replaceWith('<div class="according-menu"><i class="icofont-rounded-right"></i></div>');
    ...
    if ((contentwidth) < '992') {
        ...
        jQuery('.submenu-title').click(function () {
            ...
            jQuery('.submenu-title').find('div').replaceWith('<div class="according-menu"><i class="icofont-rounded-right"></i></div>');
            jQuery('.submenu-content').slideUp('normal');
            if (jQuery(this).next().is(':hidden') == true) {
                jQuery(this).addClass('active');
                jQuery(this).find('div').replaceWith('<div class="according-menu"><i class="icofont-rounded-down"></i></div>');
        ...
        jQuery('.sidebar-title').click(function () {
            ...
            jQuery('.sidebar-title').find('div').replaceWith('<div class="according-menu"><i class="icofont-rounded-right"></i></div>');
            jQuery('.sidebar-submenu, .menu-content').slideUp('normal');
            if (jQuery(this).next().is(':hidden') == true) {
                jQuery(this).addClass('active');
                jQuery(this).find('div').replaceWith('<div class="according-menu"><i class="icofont-rounded-down"></i></div>');
...
var lastSharp = current.lastIndexOf("#");
if (lastSharp != -1) {
    current = current.slice(0, lastSharp);
}
$(".sidebar-wrapper nav ul>li a").filter(function () {
    var link = $(this).attr("href").toLowerCase();
    var lastSharpLink = link.lastIndexOf("#");
    if (lastSharpLink != -1) {
        link = current.slice(0, lastSharpLink);
    }
    if (link) {
        if (current == link) {
            ...
            $(this).parent().parent().parent().children('a').find('div').replaceWith('<div class="according-menu"><i class="icofont-rounded-down"></i></div>');
            $(this).parent().parent().parent().parent().parent().children('a').find('div').replaceWith('<div class="according-menu"><i class="icofont-rounded-down"></i></div>');
            return false;
        }
    }
});
